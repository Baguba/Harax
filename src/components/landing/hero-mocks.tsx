    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <div className="min-w-0">
          <p className="truncate text-xs font-bold">Selam Awoke</p>
          <p className="text-[10px] text-muted-foreground">Computer Science · 3rd Year</p>
        </div>
        <span className="ml-auto rounded-full border-2 border-edge bg-lemon px-2 py-0.5 text-[9px] font-bold text-ink">CAMPUS</span>
      </div>
      ...
      <div className="mt-3 flex items-center gap-3 text-[10px] text-muted-foreground">
        <span className="inline-flex items-center gap-1 rounded-full border-2 border-edge bg-card px-2 py-1 font-bold text-red-500">
...
export function MockChatCard() {
  ...
  return (
    <motion.div
      className="glass w-60 rounded-2xl p-4"
      animate={{ y: [0, 14, 0] }}
      transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
    >
      <div className="flex items-center gap-2 border-b-2 border-edge pb-2.5">
        <span className="text-lg">☕</span>
        <div>
          <p className="text-xs font-bold">Leku Tea Room</p>
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="rounded-xl border-2 border-ink bg-lemon p-2 text-center text-foreground shadow-[0_3px_0_0_var(--bevel-lemon)]">
        ...
        <div className="min-w-0">
          <p className="text-xs font-bold leading-tight">Freshman Welcome Night</p>
      ...
      <div className="mt-3 flex items-center justify-between">
        <div className="flex -space-x-1.5">
          ...
          <span className="inline-flex h-7 items-center rounded-full bg-muted px-2 text-[9px] font-bold ring-2 ring-background">+118</span>
        </div>
        <span className="inline-flex items-center gap-1 rounded-full border-2 border-ink bg-lemon px-2.5 py-1 text-[9px] font-bold text-ink shadow-[0_2px_0_0_var(--bevel-lemon)]">
...
export function MockChannelToast() {
  return (
    <motion.div
      className="glass flex w-72 items-center gap-3 rounded-2xl p-3.5"
      animate={{ y: [0, -8, 0] }}
      transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut", delay: 2 }}
    >
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border-2 border-white/70 bg-secondary">
        <Megaphone className="h-5 w-5 text-ink" />
      </span>
      <div className="min-w-0">
        <p className="flex items-center gap-1 text-[11px] font-bold">
          Registrar Announcements
          <span className="rounded border-2 border-edge bg-lemon px-1 text-[8px] font-bold text-ink">VERIFIED</span>
        </p>
